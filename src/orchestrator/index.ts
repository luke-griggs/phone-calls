...
import { topics, type TopicConfig } from "./topics.js";
import { createExperiment, createCall } from "../db/queries.js";
import type { CreateCallRequest, CreateCallResponse } from "../types/vapi.js";
...
async function initiateCall(
  ...
  try {
    ...
    const callData = (await response.json()) as CreateCallResponse;
